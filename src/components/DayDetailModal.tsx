          ...
          {visits.length === 0 ? (
            ...
            visits.map((v) => (
              <div
                key={v.id}
                onClick={() => onEdit(v)}
                className="group bg-white p-4 rounded-xl border border-slate-200 shadow-sm hover:shadow-md hover:border-orange-200 transition cursor-pointer relative overflow-hidden"
              >
